/* ================================================================================
   ...
   ไฟล์นี้ยังอยู่เพราะเหลือ 3 หน้าที่ที่ยังมีคนใช้จริง:
     ...
     ② `houseOn()` — โหมดบ้านเปิดอยู่ไหม (ดูจากปุ่มจริงในหน้า ไม่ใช่ค่าคงที่ เพราะ main กับ
        branch ต่างกันด้วย HOUSE_FEATURE_OFF) — `OwlHome2.on()` ใช้ตัวนี้ตัดสินว่าจะกางแถวไหม
