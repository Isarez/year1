...
const CAT_REQUIRES = { thai2:'thai', iq2:'iq1', iq3:'iq2', iq4:'iq3', listen2:'listen1', 'listen-th2':'listen-th1' };

/* จำนวนคู่ (pairs) ต่อด่านของเกม skill-memory (จับคู่ตัวเลขกับจุด), index 0 = ด่าน 1 */
const MEMORY_LEVEL_PAIRS = [4, 8, 12];

/* เกมทายเงา (skill-shadow): คลังโจทย์ {e:emoji, n:ชื่อไทย} แบ่ง 3 กลุ่ม
   ตัวหลอกสุ่มจากกลุ่มเดียวกับคำตอบ (รูปทรงใกล้เคียงพอให้ท้าทายแต่แยกได้ด้วยตา)
   แต่ละกลุ่มมีของเกิน 15 ด่านรวมกันมากพอให้สุ่มเล่นซ้ำไม่ซ้ำเดิม */
const SHADOW_ITEMS = {
  animals: [
    {e:'🐘', n:'ช้าง'}, {e:'🦒', n:'ยีราฟ'}, {e:'🦁', n:'สิงโต'}, {e:'🐰', n:'กระต่าย'},
    {e:'🦆', n:'เป็ด'}, {e:'🐢', n:'เต่า'}, {e:'🦋', n:'ผีเสื้อ'}, {e:'🐟', n:'ปลา'},
    {e:'🐓', n:'ไก่'}, {e:'🐈', n:'แมว'}, {e:'🐕', n:'หมา'}, {e:'🦀', n:'ปู'},
    {e:'🐙', n:'ปลาหมึก'}, {e:'🦉', n:'นกฮูก'}, {e:'🐸', n:'กบ'}, {e:'🦈', n:'ฉลาม'},
    {e:'🐊', n:'จระเข้'}, {e:'🦩', n:'นกฟลามิงโก'}
  ],
  fruits: [
    {e:'🍌', n:'กล้วย'}, {e:'🍎', n:'แอปเปิ้ล'}, {e:'🍇', n:'องุ่น'}, {e:'🍍', n:'สับปะรด'},
    {e:'🍓', n:'สตรอว์เบอร์รี'}, {e:'🥕', n:'แครอท'}, {e:'🌽', n:'ข้าวโพด'}, {e:'🍉', n:'แตงโม'},
    {e:'🍐', n:'ลูกแพร์'}, {e:'🍒', n:'เชอร์รี'}, {e:'🥦', n:'บรอกโคลี'}, {e:'🍄', n:'เห็ด'}
  ],
  objects: [
    {e:'✈️', n:'เครื่องบิน'}, {e:'🚗', n:'รถยนต์'}, {e:'🚲', n:'จักรยาน'}, {e:'☂️', n:'ร่ม'},
    {e:'⚽', n:'ลูกบอล'}, {e:'🎸', n:'กีตาร์'}, {e:'🔑', n:'กุญแจ'}, {e:'✂️', n:'กรรไกร'},
    {e:'👟', n:'รองเท้า'}, {e:'🎩', n:'หมวก'}, {e:'🧸', n:'ตุ๊กตาหมี'}, {e:'🚀', n:'จรวด'},
    {e:'⏰', n:'นาฬิกาปลุก'}, {e:'🪁', n:'ว่าว'}, {e:'🛴', n:'สกู๊ตเตอร์'}
  ]
};
