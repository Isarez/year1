...
/* Level 1: คีย์มีตัวโน้ตกำกับ โจทย์ให้กดโน้ต 1-3 ตัวเรียงตามลำดับ ไล่ความยาก 10 ด่าน (index คีย์ขาว) */
const MUSIC_LEVEL1 = [
  [0], [2], [4],
  [0,1], [2,3], [4,5], [6,4],
  [0,2,4], [4,2,0], [0,4,7]
...
/* Level 2: เกมความจำสะสม (Simon) คีย์ยังมีตัวโน้ตกำกับ ด่าน n ให้กดโน้ตตัวที่ 1..n เรียงตามลำดับ
   เปิดเผยเฉพาะโน้ตตัวใหม่ของด่านนั้น ตัวก่อนหน้าต้องจำเอง — ครบทั้ง 10 ตัวเรียงกันเป็นเพลงจริง "ดาวน้อย" (Twinkle Twinkle) */
const MUSIC_LEVEL2_SONG = { name:'ดาวน้อย 🌟 (Twinkle Twinkle)', notes:[0,0,4,4,5,5,4,3,3,2] };
/* Level 3: เอาตัวโน้ตกำกับออก โจทย์เป็นตัวโน้ต เด็กหาคีย์ที่ถูกเอง 1-3 ตัว ไล่ความยาก 10 ด่าน (index คีย์ขาว) */
const MUSIC_LEVEL3 = [
  [1], [3], [5],
  [1,2], [3,4], [5,6], [6,5],
  [0,2,4], [7,5,4], [2,4,6]
