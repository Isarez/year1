...
(function(){
  ...
  const FIT_NAMES = {
    ...
    hair:    ['ผมสั้น','ผมบ๊อบ','ผมหางม้า','ผมยาว','ผมมวย','ผมหยิก',
              /* ⚠ index 11 เปลี่ยนทรงจาก "ผมยาวประบ่า" → "ผมมัดจุก" เมื่อ 2026-08-17 (ผู้ใช้บอกว่าทรงเดิมไม่สวย)
                 **เปลี่ยนโมเดลเมื่อไหร่ ต้องเปลี่ยนทั้งชื่อตรงนี้และไอคอนใน js/house-map.js พร้อมกันเสมอ**
                 ไม่งั้นเด็กกดซื้อ "ผมยาวประบ่า" ตามรูปแล้วได้ผมมัดจุกแทน */
              'ผมสั้นเกรียน','ผมแสกกลาง','ผมหยิกฟู','ผมหน้าม้าหนา','ผมกะลา','ผมม้าเฉียง'],
    pattern: ['เรียบ','ทางขวาง','จุด','ดาว','หัวใจ','เอี๊ยม','ซิกแซก','กระเป๋าหน้าอก','ปกกะลาสี','ทางตั้ง',
              ...
              'สายรุ้ง','หน้ายิ้ม'],
    /* ⚠ index 10 เปลี่ยนจาก "หูกระต่าย" → "หูหมี" เมื่อ 2026-08-17 (ผู้ใช้สั่ง — เบอร์ 6 เป็นหูกระต่ายอยู่แล้ว) */
    hat:     ['ไม่ใส่','หมวกแก๊ป','หมวกไหมพรม','หมวกฟาง','โบว์','มงกุฎ','หูกระต่าย','หมวกปาร์ตี้','ที่คาดผมดอกไม้',
              'หูแมว','หูหมี','หมวกบัณฑิต','หมวกปีกกว้าง','โบว์ใหญ่','ผ้าโพกหัว','หมวกกัปตัน','มงกุฎดอกไม้',
              'หมวกไหมพรมมีปอม'],
