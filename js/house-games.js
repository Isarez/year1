...
(function(){
  ...
  function houseTune(gameId, on){
    ...
    /* ✋ **ท่ามือคือคำตอบ — เฉพาะเกมนกฮูกสั่ง** (ผู้ใช้อธิบายใหม่ 2026-08-17)
       แบมือค้าง 2 วิ = ตอบ "แตะเลย!" · กำมือค้าง 2 วิ = ตอบ "ไม่แตะ"
       เกมนี้มีคำตอบแค่ 2 ทาง ท่ามือจึงแทนปุ่มได้ตรงๆ ไม่ต้องเล็งเคอร์เซอร์ให้ตรงปุ่ม
       ⚠ **ห้ามเปิดให้เกมอื่น** — เกมอื่นมีตัวเลือกมากกว่า 2 ทาง ท่ามือแทนไม่ได้ */
    if(typeof window.setHandPoseMode === 'function') window.setHandPoseMode(gameId === 'ef' && on);
  }
