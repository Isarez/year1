...
(function(){
  ...
  function houseTune(gameId, on){
    ...
    /* ✋ **แบมือ = แตะ · กำมือ = ไม่แตะ — เฉพาะเกมนกฮูกสั่ง** (ผู้ใช้สั่ง 2026-08-17)
       ปุ่มตัวเลือกของเกมนี้ใหญ่ 4 ปุ่ม ท่าแบ/กำจึงเหมาะ · เกมที่ต้องเล็งแม่น (ลากเส้น/คีย์เปียโน)
       ยังใช้จีบนิ้ว/ชี้ค้างเหมือนเดิม ไม่งั้นเด็กเผลอแบมือแล้วกดโดนของที่ไม่ได้ตั้งใจ */
    if(typeof window.setHandOpenMode === 'function') window.setHandOpenMode(gameId === 'ef' && on);
  }
