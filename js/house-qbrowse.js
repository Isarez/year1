...
(function(){
  ...
  /* ⚠ ไอคอนตัวจริงอยู่ที่ `MECH_IC` ใน js/house-quests.js — `ic:` ข้างล่างเป็นแค่ตัวสำรอง
     (`name:` ยังอยู่ที่นี่โดยตั้งใจ มีวงเล็บอธิบายเพิ่มสำหรับคนเทส เช่น "(เดิน · ทำจริง)") */
