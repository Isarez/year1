...
const STREET_LIGHT_N = 8;                  /* ดวงไฟจริงมีแค่ 8 ดวง สร้างตอนเข้าฉากครั้งเดียว แล้ววนย้ายไปเสาที่ใกล้เด็กที่สุด
                                              (เสาไฟมี 37 ต้น ถ้าใส่ PointLight ต้นละดวงจะหนักเครื่องเกินไป) */
