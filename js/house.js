...
/* ---------- ห้องในบ้าน (14×14 แบ่ง 4 ห้อง ขนาดสมส่วนตามการใช้งาน) ----------
   **ย่อจาก 20×14 เมื่อ 2026-08-07** ตามคำขอผู้ใช้ (บ้านเดิมกว้างเกิน เดินข้ามห้องนาน ของดูโล่ง):
   ...
   ├ ห้องนอน (x0-9, z8-13 ใหญ่รอง)                    ├ ห้องน้ำ (x11-13, z8-13 เล็กสุด)
   ช่องประตูระหว่างห้อง: แถว z=7 เว้น x 3-4 (นั่งเล่น↔นอน) และ x 11-12 (ครัว↔น้ำ)
   คอลัมน์บน x=8 เว้น z 2-3 (นั่งเล่น↔ครัว), คอลัมน์ล่าง x=10 เว้น z 10-11 (นอน↔น้ำ)
...
const IN_WALL_ROW = 7;
const IN_COL_TOP = 8, IN_COL_BOT = 10;   /* กำแพงแนวตั้งครึ่งบน/ครึ่งล่าง คนละแนว ให้ขนาดห้องต่างกัน */
