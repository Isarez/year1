...
/* ⏱ **เทสนี้ต้องได้เวลามากกว่าปกติ** — วนเล่นของเล่นครบ 8 ชิ้น แต่ละชิ้นรอ `petAct()` หมดเอง
   ซึ่งเดินตาม "เฟรมที่วาดจริง" ไม่ใช่นาฬิกาจริง (dt ถูกคลิปไว้ .05) ⇒ ตอนรันทั้งชุดพร้อมกัน
   WebGL โดนแย่ง GPU เฟรมตก เวลาในเกมเดินช้ากว่านาฬิกาจริงหลายเท่า
   วัดจริง 2026-08-17: รันเดี่ยวใช้ 49 วิ (เฉียดเพดาน 60 วิใน config) · รันทั้งชุดหลุด timeout
   ⚠ ห้ามแก้ด้วยการลดเวลารอในลูป — จะกลายเป็นเทสที่ผ่าน/ไม่ผ่านตามความเร็วเครื่องแทน */
