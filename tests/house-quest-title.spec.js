/* ============================================================
   ...
   🐞 บั๊กที่ชุดนี้กันไม่ให้กลับมา (ผู้ใช้แจ้ง 2026-08-22 · เจอจากภาพโปรโมท):
      ...
      ⇒ ทุกกลไกที่ไม่ใช่ `count` ถูกป้ายว่า "ตอบคำถามให้..." ทั้งหมด
      กระดานที่แจก balance/memory/shadow/whois จริงๆ จึงขึ้นบนจอเป็น "ตอบคำถาม" 5 แถว
      **ตัวสุ่มไม่ได้ผิดเลย ผิดที่ป้ายชื่อ** ⇒ เทสที่ดูแค่ค่า mech จับไม่ได้ ต้องอ่านข้อความบนจอ
   ============================================================ */
